...
module.exports = class pagaClient {
    ...
    static getSuccessMessage(url, args, tohash) {
        ...
        return new Promise((resolve, reject) => {
            ...
            request.post({
                ...
                console.log("DEBUG_PAGA_RESPONSE:",JSON.stringify(body));
                if (response.statusCode === 200) {

                    if (pagaClient.isSuccessResponse(body)) {
                        return resolve(body);
                    } else {
                        return reject(pagaClient.getAppErrorMessage(body, error, args.referenceNumber));
                    }
    ...
    static getAppErrorMessage(body, error, generatedReference = "") {
        ...
        return new AppError(500, ResponseCode.SERVICE_TEMPORARILY_UNAVAILABLE, errorMessage, [], [{ generatedReference }]);
